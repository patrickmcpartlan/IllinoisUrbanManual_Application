...
public class GoodBmp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.goodbmp);
        ...
        siltFenceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GoodBmp.this, ChooseBMP.class);
    ...
    private void updateGPS(){
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(GoodBmp.this);
        //permissions
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        StorageReference image = storageReference.child("images/good/" + name);
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(GoodBmp.this, "Image is uploaded", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(GoodBmp.this, "failed to upload", Toast.LENGTH_SHORT).show();
            }
        });
    }
    //
