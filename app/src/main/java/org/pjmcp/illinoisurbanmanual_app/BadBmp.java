...
public class BadBmp  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.badbmp);
        ...
        siltFenceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BadBmp.this, ChooseBMP.class);
    ...
    private void updateGPS(){
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(BadBmp.this);
        //permissions
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        StorageReference image = storageReference.child("images/bad/" + name);
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(BadBmp.this, "Image is uploaded", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(BadBmp.this, "failed to upload", Toast.LENGTH_SHORT).show();
            }
        });
    }
    //
